<?php
/**
 * Tool: get_video_pricing
 *
 * Retrieve current pricing rates for the Agentic Video Generation service.
 *
...
/**
 * Retrieve current pricing rates for the Agentic Video Generation service.
 * Returns credits-per-second for each model and the USD cost per credit.
 */
class Get_Video_Pricing extends \Agentic\Tool_Base {
	...
	public function get_description(): string {
		return 'Retrieve current pricing rates for the Agentic Video Generation service. Returns credits-per-second for Veo 2 and Veo 3, minimum billed duration, and cost per credit in USD. Use this before estimating the cost of a video production job.';
	}
	...
	public function execute( array $arguments ): array { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable
		...
		$response = wp_remote_get(
			\Agentic\Service_Registry::url( 'agentic-videogen', '/pricing' ),
			array(
				'timeout' => 15,
				'headers' => array(
					'X-API-Key'        => $api_key,
