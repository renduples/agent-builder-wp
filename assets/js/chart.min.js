/**
 * Chart.js v4.4.7 — UMD build (pre-minified upstream)
 *
 * Source:  https://www.npmjs.com/package/chart.js/v/4.4.7
 * License: MIT — https://github.com/chartjs/Chart.js/blob/master/LICENSE.md
 *
 * Unminified source shipped as assets/js/chart.js (same version).
 * To upgrade: replace both files with the new version from npm and update
 * the version constant in Chat_Assets::enqueue_admin_page_styles().
 */
/*!
 * Chart.js v4.4.7
